...
export const DATA = {
  ...
  summary:
    ">\n\n" +
    "**我做过的事**  \n" +
    "- 2021 年独立开发并运营「大户爱云任务」,累计服务超 2 万用户的免费自动化助手\n" +
    "- 2022 年和朋友一起上线「不是 Ai」,注册用户近 10 万,公众号粉丝近 3 万\n" +
    "- NCE Flow 开源项目发布半周内获得 1k+ Stars,被阮一峰《科技爱好者周刊》第 369 期收录\n" +
    "- 多个作品被 X、抖音、微博上的技术博主转载推荐\n" +
    "\n" +
    "**我的作品**  \n" +
    ">\n\n" +
